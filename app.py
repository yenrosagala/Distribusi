...
# ============================================================
SECTIONS = [
    {"id": "pariwisata", "title": "Pariwisata", "icon": "🏝️", "subtitle": "Hotel occupancy & length-of-stay"},
    {"id": "transportasi", "title": "Transportasi", "icon": "🚌", "subtitle": "Sea & air transport statistics"},
]
...
with st.sidebar:
    ...
    for sec in SECTIONS:
        ...
        if st.button(
            ...
            st.rerun()
        st.markdown(f'<p class="nav-subtitle">{sec["subtitle"]}</p>', unsafe_allow_html=True)
